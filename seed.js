...
const seedDatabase = async () => {
    ...
    try {
        ...
        console.log(`Created contractor: ${contractor1.firstName} ${contractor1.lastName}`);
        ...
        console.log(`Created contractor: ${contractor2.firstName} ${contractor2.lastName}`);
        ...
        console.log(`Created contractor: ${contractor3.firstName} ${contractor3.lastName}`);
        ...
        const csvContent = fs.readFileSync('./Directory_Of_Awarded_Construction_Contracts_20251207.csv', 'utf-8');
        ...
        for (const record of records) {
            try {
                ...
                const company = await companiesData.createCompany(
                    ...
                    ['New York', 'Brooklyn', 'Queens', 'Bronx'][Math.floor(Math.random() * 4)],
                    'NY',
